...
export function SidebarLayout({ children }: SidebarProps) {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground transition-colors">
            {/* Desktop Sidebar */}
            <aside className="fixed left-0 top-0 z-40 hidden h-screen w-64 flex-col border-r border-border bg-card/95 backdrop-blur md:flex">
                {/* Logo */}
                <div className="flex h-16 items-center gap-3 border-b border-border px-6">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-cobalt shadow-lg shadow-cobalt/20">
                        <svg className="h-6 w-6 text-white" fill="none" viewBox="0 0 48 48" role="img" aria-label="PixelTrack logo">
                            <path
                                clipRule="evenodd"
                    ...
                    <span className="text-lg font-bold text-foreground">Pixel Track</span>
                    <ThemeToggle className="ml-auto hidden md:inline-flex" size="sm" />
                </div>
                                    ...
                                    >
                                        <Icon
                                            className={cn(
                                                ...
                                                isActive ? 'text-cobalt' : 'text-muted-foreground group-hover:text-foreground'
                                            )}
                                        />
            ...
            {/* Mobile Header */}
            <header className="fixed left-0 right-0 top-0 z-40 flex h-16 items-center justify-between border-b border-border bg-card/90 px-4 backdrop-blur md:hidden">
                <div className="flex items-center gap-3">
                    <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-cobalt">
                        <svg className="h-5 w-5 text-white" fill="none" viewBox="0 0 48 48" role="img" aria-label="PixelTrack logo">
                            <path
                                clipRule="evenodd"
                                d="M39.475 21.6262C40.358 21.4363 40.6863 21.5589 40.7581 21.5934C40.7876 21.655 40.8547 21.857 40.8082 22.3336C40.7408 23.0255 40.4502 24.0046 39.8572 25.2301C38.6799 27.6631 36.5085 30.6631 33.5858 33.5858C30.6631 36.5085 27.6632 38.6799 25.2301 39.8572C24.0046 40.4502 23.0255 40.7407 22.3336 40.8082C21.8571 40.8547 21.6551 40.7875 21.5934 40.7581C21.5589 40.6863 21.4363 40.358 21.6262 39.475C21.8562 38.4054 22.4689 36.9657 23.5038 35.2817C24.7575 33.2417 26.5497 30.9744 28.7621 28.762C30.9744 26.5497 33.2417 24.7574 35.2817 23.5037C36.9657 22.4689 38.4054 21.8562 39.475 21.6262Z"
                                fill="currentColor"
                    ...
                    <span className="font-semibold text-foreground">Pixel Track</span>
                </div>
                ...
                <div className="flex items-center justify-around px-2 py-2">
                    {filteredNav.slice(0, 5).map((item) => {
                        ...
                        return (
                            ...
                            >
                                <Icon className={cn('h-5 w-5', isActive ? 'text-cobalt' : 'text-muted-foreground')} />
